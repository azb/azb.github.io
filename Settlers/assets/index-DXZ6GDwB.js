...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:is,depthTest:!1,depthWrite:!1})}function ru(){return new as({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Kl(),fragmentShader:`
		...
		`,blending:is,depthTest:!1,depthWrite:!1})}function ou(){return new as({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Kl(),fragmentShader:`
		...
		`,blending:is,depthTest:!1,depthWrite:!1})}function Kl(){return`
	...
	`}function ux(i){let e=new WeakMap,t=null;function n(a){if(a&&a.isTexture){const c=a.mapping,l=c===Uc||c===Oc,h=c===ir||c===sr;if(l||h){let u=e.get(a);const d=u!==void 0?u.texture.pmremVersion:0;if(a.isRenderTargetTexture&&a.pmremVersion!==d)return t===null&&(t=new iu(i)),u=l?t.fromEquirectangular(a,u):t.fromCubemap(a,u),u.texture.pmremVersion=a.pmremVersion,e.set(a,u),u.texture;if(u!==void 0)return u.texture;{const p=a.image;return l&&p&&p.height>0||h&&p&&s(p)?(t===null&&(t=new iu(i)),u=l?t.fromEquirectangular(a):t.fromCubemap(a),u.texture.pmremVersion=a.pmremVersion,e.set(a,u),a.addEventListener("dispose",r),u.texture):null}}}return a}function s(a){let c=0;const l=6;for(let h=0;h<l;h++)a[h]!==void 0&&c++;return c===l}function r(a){const c=a.target;c.removeEventListener("dispose",r);const l=e.get(c);l!==void 0&&(e.delete(c),l.dispose())}function o(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:o}}function dx(i){const e={};function t(n){if(e[n]!==void 0)return e[n];let s;switch(n){case"WEBGL_depth_texture":s=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":s=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":s=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":s=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:s=i.getExtension(n)}return e[n]=s,s}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const s=t(n);return s===null&&zr("THREE.WebGLRenderer: "+n+" extension not supported."),s}}}function fx(i,e,t,n){const s={},r=new WeakMap;function o(u){const d=u.target;d.index!==null&&e.remove(d.index);for(const g in d.attributes)e.remove(d.attributes[g]);for(const g in d.morphAttributes){const _=d.morphAttributes[g];for(let m=0,f=_.length;m<f;m++)e.remove(_[m])}d.removeEventListener("dispose",o),delete s[d.id];const p=r.get(d);p&&(e.remove(p),r.delete(d)),n.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,t.memory.geometries--}function a(u,d){return s[d.id]===!0||(d.addEventListener("dispose",o),s[d.id]=!0,t.memory.geometries++),d}function c(u){const d=u.attributes;for(const g in d)e.update(d[g],i.ARRAY_BUFFER);const p=u.morphAttributes;for(const g in p){const _=p[g];for(let m=0,f=_.length;m<f;m++)e.update(_[m],i.ARRAY_BUFFER)}}function l(u){const d=[],p=u.index,g=u.attributes.position;let _=0;if(p!==null){const M=p.array;_=p.version;for(let b=0,x=M.length;b<x;b+=3){const C=M[b+0],T=M[b+1],w=M[b+2];d.push(C,T,T,w,w,C)}}else if(g!==void 0){const M=g.array;_=g.version;for(let b=0,x=M.length/3-1;b<x;b+=3){const C=b+0,T=b+1,w=b+2;d.push(C,T,T,w,w,C)}}else return;const m=new(af(d)?df:uf)(d,1);m.version=_;const f=r.get(u);f&&e.remove(f),r.set(u,m)}function h(u){const d=r.get(u);if(d){const p=u.index;p!==null&&d.version<p.version&&l(u)}else l(u);return r.get(u)}return{get:a,update:c,getWireframeAttribute:h}}function px(i,e,t){let n;function s(d){n=d}let r,o;function a(d){r=d.type,o=d.bytesPerElement}function c(d,p){i.drawElements(n,p,r,d*o),t.update(p,n,1)}function l(d,p,g){g!==0&&(i.drawElementsInstanced(n,p,r,d*o,g),t.update(p,n,g))}function h(d,p,g){if(g===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,p,0,r,d,0,g);let m=0;for(let f=0;f<g;f++)m+=p[f];t.update(m,n,1)}function u(d,p,g,_){if(g===0)return;const m=e.get("WEBGL_multi_draw");if(m===null)for(let f=0;f<d.length;f++)l(d[f]/o,p[f],_[f]);else{m.multiDrawElementsInstancedWEBGL(n,p,0,r,d,0,_,0,g);let f=0;for(let M=0;M<g;M++)f+=p[M]*_[M];t.update(f,n,1)}}this.setMode=s,this.setIndex=a,this.render=c,this.renderInstances=l,this.renderMultiDraw=h,this.renderMultiDrawInstances=u}function mx(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,o,a){switch(t.calls++,o){case i.TRIANGLES:t.triangles+=a*(r/3);break;case i.LINES:t.lines+=a*(r/2);break;case i.LINE_STRIP:t.lines+=a*(r-1);break;case i.LINE_LOOP:t.lines+=a*r;break;case i.POINTS:t.points+=a*r;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function s(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:s,update:n}}function gx(i,e,t){const n=new WeakMap,s=new at;function r(o,a,c){const l=o.morphTargetInfluences,h=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,u=h!==void 0?h.length:0;let d=n.get(a);if(d===void 0||d.count!==u){let y=function(){L.dispose(),n.delete(a),a.removeEventListener("dispose",y)};var p=y;d!==void 0&&d.texture.dispose();const g=a.morphAttributes.position!==void 0,_=a.morphAttributes.normal!==void 0,m=a.morphAttributes.color!==void 0,f=a.morphAttributes.position||[],M=a.morphAttributes.normal||[],b=a.morphAttributes.color||[];let x=0;g===!0&&(x=1),_===!0&&(x=2),m===!0&&(x=3);let C=a.attributes.position.count*x,T=1;C>e.maxTextureSize&&(T=Math.ceil(C/e.maxTextureSize),C=e.maxTextureSize);const w=new Float32Array(C*T*4*u),L=new lf(w,C,T,u);L.type=qn,L.needsUpdate=!0;const E=x*4;for(let D=0;D<u;D++){const V=f[D],H=M[D],$=b[D],Z=C*T*4*D;for(let X=0;X<V.count;X++){const Q=X*E;g===!0&&(s.fromBufferAttribute(V,X),w[Z+Q+0]=s.x,w[Z+Q+1]=s.y,w[Z+Q+2]=s.z,w[Z+Q+3]=0),_===!0&&(s.fromBufferAttribute(H,X),w[Z+Q+4]=s.x,w[Z+Q+5]=s.y,w[Z+Q+6]=s.z,w[Z+Q+7]=0),m===!0&&(s.fromBufferAttribute($,X),w[Z+Q+8]=s.x,w[Z+Q+9]=s.y,w[Z+Q+10]=s.z,w[Z+Q+11]=$.itemSize===4?s.w:1)}}d={count:u,texture:L,size:new Re(C,T)},n.set(a,d),a.addEventListener("dispose",y)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)c.getUniforms().setValue(i,"morphTexture",o.morphTexture,t);else{let g=0;for(let m=0;m<l.length;m++)g+=l[m];const _=a.morphTargetsRelative?1:1-g;c.getUniforms().setValue(i,"morphTargetBaseInfluence",_),c.getUniforms().setValue(i,"morphTargetInfluences",l)}c.getUniforms().setValue(i,"morphTargetsTexture",d.texture,t),c.getUniforms().setValue(i,"morphTargetsTextureSize",d.size)}return{update:r}}function _x(i,e,t,n){let s=new WeakMap;function r(c){const l=n.render.frame,h=c.geometry,u=e.get(c,h);if(s.get(u)!==l&&(e.update(u),s.set(u,l)),c.isInstancedMesh&&(c.hasEventListener("dispose",a)===!1&&c.addEventListener("dispose",a),s.get(c)!==l&&(t.update(c.instanceMatrix,i.ARRAY_BUFFER),c.instanceColor!==null&&t.update(c.instanceColor,i.ARRAY_BUFFER),s.set(c,l))),c.isSkinnedMesh){const d=c.skeleton;s.get(d)!==l&&(d.update(),s.set(d,l))}return u}function o(){s=new WeakMap}function a(c){const l=c.target;l.removeEventListener("dispose",a),t.remove(l.instanceMatrix),l.instanceColor!==null&&t.remove(l.instanceColor)}return{update:r,dispose:o}}class _f extends Ht{constructor(e,t,n,s,r,o,a,c,l,h=Zs){if(h!==Zs&&h!==or)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&h===Zs&&(n=Es),n===void 0&&h===or&&(n=rr),super(null,s,r,o,a,c,h,n,l),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=a!==void 0?a:fn,this.minFilter=c!==void 0?c:fn,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}}const xf=new Ht,au=new _f(1,1),vf=new lf,yf=new ig,Mf=new mf,cu=[],lu=[],hu=new Float32Array(16),uu=new Float32Array(9),du=new Float32Array(4);function gr(i,e,t){const n=i[0];if(n<=0||n>0)return i;const s=e*t;let r=cu[s];if(r===void 0&&(r=new Float32Array(s),cu[s]=r),e!==0){n.toArray(r,0);for(let o=1,a=0;o!==e;++o)a+=t,i[o].toArray(r,a)}return r}function Gt(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function Wt(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function ya(i,e){let t=lu[e];t===void 0&&(t=new Int32Array(e),lu[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function xx(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function vx(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Gt(t,e))return;i.uniform2fv(this.addr,e),Wt(t,e)}}function yx(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(Gt(t,e))return;i.uniform3fv(this.addr,e),Wt(t,e)}}function Mx(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Gt(t,e))return;i.uniform4fv(this.addr,e),Wt(t,e)}}function Sx(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(Gt(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),Wt(t,e)}else{if(Gt(t,n))return;du.set(n),i.uniformMatrix2fv(this.addr,!1,du),Wt(t,n)}}function bx(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(Gt(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),Wt(t,e)}else{if(Gt(t,n))return;uu.set(n),i.uniformMatrix3fv(this.addr,!1,uu),Wt(t,n)}}function Ex(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(Gt(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),Wt(t,e)}else{if(Gt(t,n))return;hu.set(n),i.uniformMatrix4fv(this.addr,!1,hu),Wt(t,n)}}function Tx(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function Ax(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Gt(t,e))return;i.uniform2iv(this.addr,e),Wt(t,e)}}function wx(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Gt(t,e))return;i.uniform3iv(this.addr,e),Wt(t,e)}}function Rx(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Gt(t,e))return;i.uniform4iv(this.addr,e),Wt(t,e)}}function Cx(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function Px(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Gt(t,e))return;i.uniform2uiv(this.addr,e),Wt(t,e)}}function Lx(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Gt(t,e))return;i.uniform3uiv(this.addr,e),Wt(t,e)}}function Dx(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Gt(t,e))return;i.uniform4uiv(this.addr,e),Wt(t,e)}}function Ix(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s);let r;this.type===i.SAMPLER_2D_SHADOW?(au.compareFunction=of,r=au):r=xf,t.setTexture2D(e||r,s)}function Nx(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture3D(e||yf,s)}function Ux(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTextureCube(e||Mf,s)}function Ox(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture2DArray(e||vf,s)}function Fx(i){switch(i){case 5126:return xx;case 35664:return vx;case 35665:return yx;case 35666:return Mx;case 35674:return Sx;case 35675:return bx;case 35676:return Ex;case 5124:case 35670:return Tx;case 35667:case 35671:return Ax;case 35668:case 35672:return wx;case 35669:case 35673:return Rx;case 5125:return Cx;case 36294:return Px;case 36295:return Lx;case 36296:return Dx;case 35678:case 36198:case 36298:case 36306:case 35682:return Ix;case 35679:case 36299:case 36307:return Nx;case 35680:case 36300:case 36308:case 36293:return Ux;case 36289:case 36303:case 36311:case 36292:return Ox}}function Bx(i,e){i.uniform1fv(this.addr,e)}function kx(i,e){const t=gr(e,this.size,2);i.uniform2fv(this.addr,t)}function zx(i,e){const t=gr(e,this.size,3);i.uniform3fv(this.addr,t)}function Hx(i,e){const t=gr(e,this.size,4);i.uniform4fv(this.addr,t)}function Vx(i,e){const t=gr(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function Gx(i,e){const t=gr(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function Wx(i,e){const t=gr(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function Xx(i,e){i.uniform1iv(this.addr,e)}function $x(i,e){i.uniform2iv(this.addr,e)}function Yx(i,e){i.uniform3iv(this.addr,e)}function jx(i,e){i.uniform4iv(this.addr,e)}function qx(i,e){i.uniform1uiv(this.addr,e)}function Kx(i,e){i.uniform2uiv(this.addr,e)}function Zx(i,e){i.uniform3uiv(this.addr,e)}function Jx(i,e){i.uniform4uiv(this.addr,e)}function Qx(i,e,t){const n=this.cache,s=e.length,r=ya(t,s);Gt(n,r)||(i.uniform1iv(this.addr,r),Wt(n,r));for(let o=0;o!==s;++o)t.setTexture2D(e[o]||xf,r[o])}function ev(i,e,t){const n=this.cache,s=e.length,r=ya(t,s);Gt(n,r)||(i.uniform1iv(this.addr,r),Wt(n,r));for(let o=0;o!==s;++o)t.setTexture3D(e[o]||yf,r[o])}function tv(i,e,t){const n=this.cache,s=e.length,r=ya(t,s);Gt(n,r)||(i.uniform1iv(this.addr,r),Wt(n,r));for(let o=0;o!==s;++o)t.setTextureCube(e[o]||Mf,r[o])}function nv(i,e,t){const n=this.cache,s=e.length,r=ya(t,s);Gt(n,r)||(i.uniform1iv(this.addr,r),Wt(n,r));for(let o=0;o!==s;++o)t.setTexture2DArray(e[o]||vf,r[o])}function iv(i){switch(i){case 5126:return Bx;case 35664:return kx;case 35665:return zx;case 35666:return Hx;case 35674:return Vx;case 35675:return Gx;case 35676:return Wx;case 5124:case 35670:return Xx;case 35667:case 35671:return $x;case 35668:case 35672:return Yx;case 35669:case 35673:return jx;case 5125:return qx;case 36294:return Kx;case 36295:return Zx;case 36296:return Jx;case 35678:case 36198:case 36298:case 36306:case 35682:return Qx;case 35679:case 36299:case 36307:return ev;case 35680:case 36300:case 36308:case 36293:return tv;case 36289:case 36303:case 36311:case 36292:return nv}}class sv{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=Fx(t.type)}}class rv{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=iv(t.type)}}class ov{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const s=this.seq;for(let r=0,o=s.length;r!==o;++r){const a=s[r];a.setValue(e,t[a.id],n)}}}const cc=/(\w+)(\])?(\[|\.)?/g;function fu(i,e){i.seq.push(e),i.map[e.id]=e}function av(i,e,t){const n=i.name,s=n.length;for(cc.lastIndex=0;;){const r=cc.exec(n),o=cc.lastIndex;let a=r[1];const c=r[2]==="]",l=r[3];if(c&&(a=a|0),l===void 0||l==="["&&o+2===s){fu(t,l===void 0?new sv(a,i,e):new rv(a,i,e));break}else{let u=t.map[a];u===void 0&&(u=new ov(a),fu(t,u)),t=u}}}class ra{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let s=0;s<n;++s){const r=e.getActiveUniform(t,s),o=e.getUniformLocation(t,r.name);av(r,o,this)}}setValue(e,t,n,s){const r=this.map[t];r!==void 0&&r.setValue(e,n,s)}setOptional(e,t,n){const s=t[n];s!==void 0&&this.setValue(e,n,s)}static upload(e,t,n,s){for(let r=0,o=t.length;r!==o;++r){const a=t[r],c=n[a.id];c.needsUpdate!==!1&&a.setValue(e,c.value,s)}}static seqWithValue(e,t){const n=[];for(let s=0,r=e.length;s!==r;++s){const o=e[s];o.id in t&&n.push(o)}return n}}function pu(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}const cv=37297;let lv=0;function hv(i,e){const t=i.split(`
`),n=[],s=Math.max(e-6,0),r=Math.min(e+6,t.length);for(let o=s;o<r;o++){const a=o+1;n.push(`${a===e?">":" "} ${a}: ${t[o]}`)}return n.join(`
`)}const mu=new He;function uv(i){Ke._getMatrix(mu,Ke.workingColorSpace,i);const e=`mat3( ${mu.elements.map(t=>t.toFixed(4))} )`;switch(Ke.getTransfer(i)){case va:return[e,"LinearTransferOETF"];case mt:return[e,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",i),[e,"LinearTransferOETF"]}}function gu(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),s=i.getShaderInfoLog(e).trim();if(n&&s==="")return"";const r=/ERROR: 0:(\d+)/.exec(s);if(r){const o=parseInt(r[1]);return t.toUpperCase()+`

`+s+`

`+hv(i.getShaderSource(e),o)}else return s}function dv(i,e){const t=uv(e);return[`vec4 ${i}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}function fv(i,e){let t;switch(e){case fm:t="Linear";break;case pm:t="Reinhard";break;case mm:t="Cineon";break;case Xd:t="ACESFilmic";break;case _m:t="AgX";break;case xm:t="Neutral";break;case gm:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Fo=new P;function pv(){Ke.getLuminanceCoefficients(Fo);const i=Fo.x.toFixed(4),e=Fo.y.toFixed(4),t=Fo.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function mv(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",i.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Hr).join(`
`)}function gv(i){const e=[];for(const t in i){const n=i[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function _v(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){const r=i.getActiveAttrib(e,s),o=r.name;let a=1;r.type===i.FLOAT_MAT2&&(a=2),r.type===i.FLOAT_MAT3&&(a=3),r.type===i.FLOAT_MAT4&&(a=4),t[o]={type:r.type,location:i.getAttribLocation(e,o),locationSize:a}}return t}function Hr(i){return i!==""}function _u(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function xu(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const xv=/^[ \t]*#include +<([\w\d./]+)>/gm;function ul(i){return i.replace(xv,yv)}const vv=new Map;function yv(i,e){let t=Ge[e];if(t===void 0){const n=vv.get(e);if(n!==void 0)t=Ge[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return ul(t)}const Mv=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function vu(i){return i.replace(Mv,Sv)}function Sv(i,e,t,n){let s="";for(let r=parseInt(e);r<parseInt(t);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function yu(i){let e=`precision ${i.precision} float;
...
#define LOW_PRECISION`),e}function bv(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Fl?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===Gd?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===Mi&&(e="SHADOWMAP_TYPE_VSM"),e}function Ev(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case ir:case sr:e="ENVMAP_TYPE_CUBE";break;case xa:e="ENVMAP_TYPE_CUBE_UV";break}return e}function Tv(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case sr:e="ENVMAP_MODE_REFRACTION";break}return e}function Av(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Wd:e="ENVMAP_BLENDING_MULTIPLY";break;case um:e="ENVMAP_BLENDING_MIX";break;case dm:e="ENVMAP_BLENDING_ADD";break}return e}function wv(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function Rv(i,e,t,n){const s=i.getContext(),r=t.defines;let o=t.vertexShader,a=t.fragmentShader;const c=bv(t),l=Ev(t),h=Tv(t),u=Av(t),d=wv(t),p=mv(t),g=gv(r),_=s.createProgram();let m,f,M=t.glslVersion?"#version "+t.glslVersion+`
...
`)+`
`+f);const b=M+m+o,x=M+f+a,C=pu(s,s.VERTEX_SHADER,b),T=pu(s,s.FRAGMENT_SHADER,x);s.attachShader(_,C),s.attachShader(_,T),t.index0AttributeName!==void 0?s.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(_,0,"position"),s.linkProgram(_);function w(D){if(i.debug.checkShaderErrors){const V=s.getProgramInfoLog(_).trim(),H=s.getShaderInfoLog(C).trim(),$=s.getShaderInfoLog(T).trim();let Z=!0,X=!0;if(s.getProgramParameter(_,s.LINK_STATUS)===!1)if(Z=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,_,C,T);else{const Q=gu(s,C,"vertex"),W=gu(s,T,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(_,s.VALIDATE_STATUS)+`
...
${a}`:a}function Cb(i,e){const t=i.player();Le("turn-banner").textContent=`${t.name}'s turn`,Le("turn-banner").style.color=t.color;const n=wb(i);Le("phase-label").textContent=n;const s=ho(i),r=Sr(i),o=r?s?`${s.diceLine} · ${r}`:r:s?s.banner:n,a=Le("table-help");a&&(a.textContent=o,a.classList.toggle("hidden",!o));const c=Le("roll-result");c&&(c.textContent=r?o:s?s.banner:"",c.classList.toggle("hidden",!c.textContent));const l=Rn(i),h=Ta(i),u=Le("score-strip");u&&(u.innerHTML=h.map(C=>`<button type="button" class="score-chip ${C.id===i.current?"active":""}" data-scores="1" style="--chip:${C.color};color:${tp(C.color)}">
        ...
        <div class="player-break">${Yf(C)}</div>
    ...
    </div>`).join("");const g=l,_=!g.isAI&&g.id===i.current,m=g.devCards.filter(C=>C.type!==Mt.VP).map(C=>{const T={[Mt.KNIGHT]:"Knight",[Mt.ROAD]:"Road Building",[Mt.PLENTY]:"Year of Plenty",[Mt.MONOPOLY]:"Monopoly"},w=i.playableCards(g.id).some(L=>L.id===C.id);return`<button data-dev="${C.id}" ${w&&_?"":"disabled"}>${T[C.type]}${C.playable?"":" (hold)"}</button>`}),f=g.devCards.filter(C=>C.type===Mt.VP).length;f&&m.push(`<button disabled>${f} VP card${f>1?"s":""}</button>`),Le("dev-bar").innerHTML=m.join("")||"<button disabled>No development cards</button>";const M=(C,T,w,L)=>`<button type="button" data-act="${C}" class="${e===C?"primary":""} ${w?"":"is-disabled"}" ${w?"":'aria-disabled="true"'}>${L?`<span class="act-name">${T}</span><span class="act-cost">${L}</span>`:T}</button>`,b=i.phase===F.MAIN&&_,x=i.phase===F.FREE_ROADS&&_;Le("action-bar").innerHTML=[M("roll","Roll dice",i.phase===F.ROLL&&_),M("road","Road",b&&i.canAfford(g.id,"road")||x,x?"Free":Ri(pt.road)),M("settlement","Settlement",b&&i.canAfford(g.id,"settlement"),Ri(pt.settlement)),M("city","City",b&&i.canAfford(g.id,"city"),Ri(pt.city)),M("dev","Dev",b&&i.canAfford(g.id,"dev")&&i.devDeck.length,Ri(pt.dev)),M("trade","Bank",b,"4:1"),M("end","End turn",b)].join(""),Le("log").innerHTML=[...i.log].slice(-12).reverse().map(C=>`<li>${C}</li>`).join("")}function El(i){const e=i.discardQueue.map(t=>i.player(t.player).name);return e.length?`${e.join(", ")} must discard half`:"Discard half your cards"}function Ta(i){if(!i)return[];const e=Rn(i);return i.players.map(t=>{const n=i.scoreFacts(t),s=t.id===e.id;return{id:t.id,name:t.name,color:t.color,isYou:s,settlements:n.settlements,cities:n.cities,longestRoad:n.longestRoad,largestArmy:n.largestArmy,hiddenVP:s?n.hiddenVP:0,publicVP:n.publicVP,shownVP:s?n.totalVP:n.publicVP}})}function Yf(i){const e=i.settlements,t=i.cities,n=[`${e} settlement${e===1?"":"s"}`,`${t} cit${t===1?"y":"ies"}`];return i.longestRoad&&n.push("Longest Road +2"),i.largestArmy&&n.push("Largest Army +2"),i.isYou&&i.hiddenVP&&n.push(`You: ${i.hiddenVP} VP card${i.hiddenVP>1?"s":""}`),n.join(" · ")}function Rn(i){if(i.players.some(t=>!t.isAI)===!1)return i.player();const e=i.players.filter(t=>!t.isAI);return e.length===1?e[0]:i.player()}function Pb(i){var e,t,n,s;Le("action-bar").addEventListener("click",r=>{const o=r.target.closest("button[data-act]");o&&(o.getAttribute("aria-disabled")==="true"?i("failBuild",o.dataset.act):i(o.dataset.act))}),Le("dev-bar").addEventListener("click",r=>{const o=r.target.closest("button[data-dev]");o&&i("playDev",o.dataset.dev)}),Le("players-panel").addEventListener("click",r=>{const o=r.target.closest("[data-steal]");o&&i("steal",Number(o.dataset.steal))}),(e=Le("score-strip"))==null||e.addEventListener("click",r=>{r.target.closest("[data-scores]")&&i("scores")}),(t=Le("scores-btn"))==null||t.addEventListener("click",()=>i("scores")),(n=Le("settings-btn"))==null||n.addEventListener("click",()=>i("settings")),(s=Le("title-settings-btn"))==null||s.addEventListener("click",()=>i("settings"))}const Lb=2200,jf=5200;function Un(i,e=Lb,t=null){const n=Le("toast");n.textContent=i,n.classList.toggle("toast-low",!!(t!=null&&t.low)),n.classList.remove("hidden"),clearTimeout(Un._t),Un._t=setTimeout(()=>n.classList.add("hidden"),e)}const Tl=12;function Db(i){if(!i||i.classList.contains("hidden"))return null;const e=i.getBoundingClientRect();return e.width<1||e.height<1?null:e}function Ib(i,e,t=Tl){return i.left<e.right+t&&i.right+t>e.left&&i.top<e.bottom+t&&i.bottom+t>e.top}function qf(){const i=Le("modal"),e=Le("modal-body");if(!i||!e||i.classList.contains("hidden")||!i.classList.contains("scores-modal"))return;e.style.top="",e.style.maxHeight="";const t=[document.querySelector(".top-actions"),Le("score-strip"),Le("turn-banner"),Le("table-help"),Le("phase-label"),Le("roll-result")].map(Db).filter(Boolean);let n=Math.max(72,...t.map(r=>r.bottom+Tl));e.style.top=`${Math.round(n)}px`,e.style.maxHeight=`${Math.max(160,Math.round(window.innerHeight-n-16))}px`;const s=e.getBoundingClientRect();for(const r of t)Ib(s,r)&&(n=Math.max(n,r.bottom+Tl));e.style.top=`${Math.round(n)}px`,e.style.maxHeight=`${Math.max(160,Math.round(window.innerHeight-n-16))}px`}function Al(){Al._bound||(Al._bound=!0,window.addEventListener("resize",qf))}function Ct(){const i=Le("modal");i.classList.add("hidden"),i.classList.remove("scores-modal");const e=Le("modal-body");e&&(e.style.top="",e.style.maxHeight="")}function di(i,e={}){const t=Le("modal"),n=Le("modal-body");n.innerHTML=i,n.style.top="",n.style.maxHeight="",t.classList.toggle("scores-modal",e.variant==="scores"),t.classList.remove("hidden"),e.variant==="scores"&&(Al(),requestAnimationFrame(qf))}function Kf(i,e=""){return`<div class="picker" id="${i}">${Xe.map(t=>`<button type="button" data-res="${t}" style="border-color:${wn[t]}">${st[t]}</button>`).join("")}</div>${e}`}function Zf(i,e){const t=i.discardQueue.filter(a=>!i.player(a.player).isAI);if(!t.length)return!1;const n=t[0],s=i.player(n.player),r=Object.fromEntries(Xe.map(a=>[a,0])),o=()=>{const a=Xe.reduce((c,l)=>c+r[l],0);di(`<h2>${s.name}, discard ${n.must}</h2>
    ...
    <div class="picker steal-picker">${t}</div>`),Le("modal-body").onclick=n=>{var r;const s=(r=n.target.closest("button[data-steal]"))==null?void 0:r.dataset.steal;s!=null&&(Ct(),e(Number(s)))}}function Nb(i,e){let t=null,n=null;const s=Rn(i),r=()=>{var h,u;const o=t?i.tradeRate(s,t):4,a=t&&n&&i.canBankTrade(s.id,t,n),c=t&&n?i.whyNotBankTrade(s.id,t,n):null,l=t?`Bank ${o}:1 — give ${o} ${st[t]} for 1 of another.`:"Bank 4:1 (3:1 or 2:1 with a matching port). Give extras, take one.";di(`<h2>Bank trade</h2>
      ...
      <button id="trade-cancel">Cancel</button>`),t&&((h=Le("give-p").querySelector(`[data-res="${t}"]`))==null||h.classList.add("selected")),n&&((u=Le("get-p").querySelector(`[data-res="${n}"]`))==null||u.classList.add("selected")),Le("give-p").onclick=d=>{var g;const p=Ei((g=d.target.closest("[data-res]"))==null?void 0:g.dataset.res);!p||(s.resources[p]||0)<i.tradeRate(s,p)||(t=p,n===t&&(n=null),r())},Le("get-p").onclick=d=>{var g;const p=Ei((g=d.target.closest("[data-res]"))==null?void 0:g.dataset.res);!p||p===t||(i.bank[p]||0)<1||(n=p,r())},Le("trade-go").onclick=()=>{a&&(Ct(),e(t,n))},Le("trade-cancel").onclick=()=>{Ct(),e(null,null)}};r()}function Qf(i){const e=[],t=()=>{di(`<h2>Year of Plenty</h2><p>Pick two resources (${e.length}/2) — use the panel in VR.</p>
      ${Kf("pl")}
      <p>${e.map(n=>st[n]).join(", ")}</p>`),Le("pl").onclick=n=>{const s=n.target.dataset.res;s&&(e.push(s),e.length>=2?(Ct(),i(e[0],e[1])):t())}};t()}function ep(i){di(`<h2>Monopoly</h2><p>Name a resource on the panel or below.</p>${Kf("mo")}`),Le("mo").onclick=e=>{const t=e.target.dataset.res;t&&(Ct(),i(t))}}function tp(i){const e=String(i||"").replace("#","");if(e.length<6)return"#f7efe0";const t=parseInt(e.slice(0,2),16),n=parseInt(e.slice(2,4),16),s=parseInt(e.slice(4,6),16);return(t*299+n*587+s*114)/1e3>160?"#1a120c":"#f7efe0"}function Ub(i,e){const t=Ta(i);di(`<h2>Scores</h2>
    ...
    ${t.map(n=>`<article class="score-break">
        ...
        <div class="player-break">${Yf(n)}</div>
      </article>`).join("")}
    <button id="scores-back" class="primary" type="button">Back</button>`,{variant:"scores"}),Le("scores-back").onclick=()=>{Ct(),e==null||e()}}function np(i,{onPlayAgain:e,onMainMenu:t}={}){const n=i.player(i.winner),s=tp(n.color);di(`<h2 class="win-title" style="background:${n.color};color:${s}">${n.name} Wins!</h2>
    ...
    </div>`),Le("again").onclick=()=>{Ct(),e==null||e()},Le("win-menu").onclick=()=>{Ct(),t==null||t()}}function Ob(i,e){const t=n=>n?"primary":"";di(`<h2>Settings</h2>
    ...
    </div>`),Le("modal-body").onclick=n=>{var r;const s=(r=n.target.closest("[data-act]"))==null?void 0:r.dataset.act;s&&e(s)}}function Fb(i,e){di(`<h2>Pointer tilt</h2>
    ...
    </div>`),Le("modal-body").onclick=t=>{var s;const n=(s=t.target.closest("[data-act]"))==null?void 0:s.dataset.act;n&&e(n)}}function ip(i){di(`<h2>Restart game?</h2>
    <p>This starts a new island (same player count and mode).</p>
    <button id="restart-go" class="primary">Restart</button>
    <button id="restart-back">Back</button>`),Le("restart-go").onclick=()=>{Ct(),i(!0)},Le("restart-back").onclick=()=>{Ct(),i(!1)}}let Br;function sp(){return Br||(Br=new(window.AudioContext||window.webkitAudioContext)),Br.state==="suspended"&&Br.resume(),Br}function xs(i,e=.12,t="sine",n=.06){const s=sp(),r=s.createOscillator(),o=s.createGain();r.type=t,r.frequency.value=i,o.gain.value=n,o.gain.exponentialRampToValueAtTime(1e-4,s.currentTime+e),r.connect(o).connect(s.destination),r.start(),r.stop(s.currentTime+e)}const We={unlock:()=>sp(),dice:()=>{xs(180,.05,"square",.04),setTimeout(()=>xs(140,.08,"triangle",.05),80),setTimeout(()=>xs(90,.12,"sawtooth",.03),160)},place:()=>xs(220,.1,"triangle",.05),click:()=>xs(520,.05,"square",.03),win:()=>{[262,330,392,523].forEach((i,e)=>setTimeout(()=>xs(i,.28,"sine",.07),e*140))},bad:()=>xs(90,.16,"sawtooth",.04)};let sn=Te.antialias;try{const i=localStorage.getItem("catan-antialias");i==="1"?sn=!0:i==="0"&&(sn=!1)}catch{}Te.antialias=sn;const ma={antialias:sn};function Bb(){const i=e=>{if(!(e!=null&&e.getContextAttributes)||e.getContextAttributes.__catanAa)return;const t=e.getContextAttributes;e.getContextAttributes=function(){const s=t.call(this);return s&&(Object.assign(ma,s,{antialias:sn}),ma)},e.getContextAttributes.__catanAa=!0};i(WebGLRenderingContext.prototype),typeof WebGL2RenderingContext<"u"&&i(WebGL2RenderingContext.prototype)}Bb();const br=document.getElementById("scene"),be=new ay({canvas:br,antialias:sn,alpha:!0});be.setPixelRatio(Te.pixelRatio);be.setSize(innerWidth,innerHeight);be.setClearColor(1774607,1);be.shadowMap.enabled=Te.shadows;be.shadowMap.type=IS();be.xr.enabled=!0;be.xr.setFramebufferScaleFactor(Te.framebufferScale);be.outputColorSpace=Lt;be.toneMapping=Xd;be.toneMappingExposure=1.05;const Fn=new cy,ct=new Ze;ct.name="stage";const Aa=-1.32,kb=.4,wl=.5,Sc=.05,bd=90;ct.position.set(0,0,Aa);Fn.add(ct);const kt=new hn(60,innerWidth/innerHeight,.05,30);kt.position.set(0,1.17,.62);Fn.add(kt);const gn=new Ky(kt,br);gn.target.set(0,.57,Aa);gn.enableDamping=!0;gn.enablePan=!0;gn.screenSpacePanning=!0;gn.panSpeed=1.25;gn.maxPolarAngle=Math.PI*.48;gn.minDistance=.6;gn.maxDistance=3.2;gn.mouseButtons.LEFT=Pi.PAN;gn.mouseButtons.MIDDLE=Pi.DOLLY;gn.mouseButtons.RIGHT=Pi.ROTATE;gn.touches.ONE=Qi.PAN;gn.touches.TWO=Qi.DOLLY_ROTATE;gn.listenToKeyEvents(window);br.addEventListener("contextmenu",i=>i.preventDefault());const rp=new De("#1b140f");Fn.background=rp;Fn.fog=new Ma("#1b140f",6,12);const sh=BS(ct);la(!1);const $e=new WS(ct);$e.rebuild(new Bf({seed:2026}).board);const ai=new KS(ct),Ue=new ZS(ct),ii=new tb(kt),dr=IE(),Ti=NE(),rs=new rb(ct),uo=new mb(ct),fo=new Ab(ct),on=new jS(Fn,ct),Oi=new P,Rl=new Jn,Ed=new Qn,Zo=new P,si=new P,ri=new P,Td=new P,Ad=new P(0,1,0),Ki=new P,$n=new P,Tn=new P,wd=new P,Jo=new P,un=new Map;let Gn=null,Zr=!1,Jr=null,Rd="local-floor",er=!1,tr=0,Qr=!1;const bc={select:!1,selectstart:!1,selectend:!1},zb=320;let op=0,ga=null;const ap=4,Cl=["local-floor","bounded-floor","hand-tracking","transient-pointer","unbounded"],wa=4,Hb=.003,Cd=.004,Pd=new Fy,$t=new Yy,eo=new Re;let An="controller";try{const i=localStorage.getItem("catan-pointer-mode");(i==="gaze"||i==="controller")&&(An=i)}catch{}const _a=2,Ld=20;let Zn=0;try{const i=localStorage.getItem("catan-pointer-tilt");i!=null&&(Zn=hp(i))}catch{}let ci=!0;try{const i=localStorage.getItem("catan-pointer-lines");i==="0"?ci=!1:i==="1"&&(ci=!0)}catch{}const rh=DE();Ii();let A=null;Bi();let fr=null,Ft=!1,Oe=!1,bs=3,pr=!0,Wn=!1,As=!0,ye="actions",Yt=null,rn=null,an=Fi(),ws="",On=[];const cp=new Set(["settings","settingsBack","passthrough","handles","restart","restartAsk","restartBack","pointer","pointerLines","antialias","pointerTilt","pointerTiltUp","pointerTiltDown","pointerTiltBack"]),Vb=new Set(["road","settlement","city","dev","cards"]),lp=new P,Gb={[Mt.KNIGHT]:"Knight",[Mt.ROAD]:"Road Building",[Mt.PLENTY]:"Year of Plenty",[Mt.MONOPOLY]:"Monopoly"};function Fi(){return Object.fromEntries(Xe.map(i=>[i,0]))}function hp(i){const e=Math.round(Number(i)/_a)*_a;return Number.isFinite(e)?Math.max(-Ld,Math.min(Ld,e)):0}function Ra(){return Zn>0?`+${Zn}°`:`${Zn}°`}function Dd(i){Zn=hp(i);try{localStorage.setItem("catan-pointer-tilt",String(Zn))}catch{}}function Vt(){return be.xr.isPresenting}function Bi(){const i=Vt();Ue.setVisible(i),i||(ii.mesh.visible=!1),document.documentElement.classList.toggle("xr-presenting",i),Wb()}function Wb(){const i=document.getElementById("hud"),e=document.getElementById("start-screen");!i||!e||(A?(i.classList.remove("hidden"),e.classList.add("hidden"),e.hidden=!0,e.setAttribute("inert","")):(i.classList.add("hidden"),e.classList.remove("hidden"),e.hidden=!1,e.removeAttribute("inert")))}function Ys(i,e){return typeof i!="string"||!i.startsWith(e)?null:i.slice(e.length)}function to(){const i=document.getElementById("player-count");if(i)for(const t of i.children)t.classList.toggle("active",Number(t.dataset.count)===bs);const e=document.getElementById("play-mode");if(e)for(const t of e.children)t.classList.toggle("active",t.dataset.mode==="solo"===pr)}document.getElementById("player-count").addEventListener("click",i=>{const e=i.target.closest("button[data-count]");e&&(bs=Number(e.dataset.count),to(),A||_t())});document.getElementById("play-mode").addEventListener("click",i=>{const e=i.target.closest("button[data-mode]");e&&(pr=e.dataset.mode==="solo",to(),A||_t())});document.getElementById("start-btn").addEventListener("click",()=>{We.unlock(),cs()});document.getElementById("new-game-btn").addEventListener("click",()=>{up({fromHud:!0})});document.getElementById("vr-btn").addEventListener("click",KE);window.addEventListener("resize",QE);br.addEventListener("pointermove",i=>{if(eo.x=i.clientX/innerWidth*2-1,eo.y=-(i.clientY/innerHeight)*2+1,ns&&Ue.pressAction){const e=i.clientX-ns.x,t=i.clientY-ns.y;e*e+t*t>=256&&Ue.setPressed(null)}});let ns=null;br.addEventListener("pointerdown",i=>{var t;if(We.unlock(),ns={x:i.clientX,y:i.clientY},be.xr.isPresenting)return;$t.setFromCamera(eo,kt);const e=Ia($t.intersectObjects(Da(),!0));((t=e==null?void 0:e.userData)==null?void 0:t.kind)==="tray"&&!e.userData.disabled&&Ue.setPressed(e.userData.action)});br.addEventListener("pointerup",i=>{if(!ns||be.xr.isPresenting)return;const e=i.clientX-ns.x,t=i.clientY-ns.y;ns=null,e*e+t*t<256?bE():Ue.setPressed(null)});function no(i,e){if(i==="scores"){fp();return}if(i==="settings"){rE();return}if(i==="failBuild"){if(!A)return;const t=e==="roll"?_p():e==="end"?"Finish your turn from the panel when it is Main.":e==="trade"?"Bank trades are on your turn after rolling.":vp(e);qs(t,{userData:{kind:"tray",action:e}});return}if(!(!A||Ft)){if(i==="steal"){Tr(e);return}if(i==="dev"){const t=Rn(A).id;if(!A.buyDev(t)){qs(A.whyNotDev(t),{userData:{kind:"tray",action:"dev"}});return}We.click(),Ut();return}if(We.click(),i==="roll"){const t=A.roll();t&&(ai.placeFor(A.current,A.playerCount),ai.rollTo(t),We.dice(),Hp()),Ut();return}if(i==="end"){A.endTurn(),Ut();return}if(i==="trade"){aE();return}if(i==="playDev"){A.playDev(e),Ut();return}fr=i,ki()}}Pb(no);let io=null;var zd;(zd=document.getElementById("spot-layer"))==null||zd.addEventListener("pointerover",i=>{const e=i.target.closest("[data-vertex]");io=(e==null?void 0:e.dataset.vertex)??null});var Hd;(Hd=document.getElementById("spot-layer"))==null||Hd.addEventListener("pointerout",i=>{const e=i.target.closest("[data-vertex]");e&&io===e.dataset.vertex&&(io=null)});var Vd;(Vd=document.getElementById("spot-layer"))==null||Vd.addEventListener("click",i=>{const e=i.target.closest("[data-vertex]");e&&lh({userData:{kind:"vertex",id:e.dataset.vertex}})});be.setAnimationLoop(()=>{var t,n,s,r,o,a;const i=Pd.getDelta();be.xr.isPresenting||gn.update(),ai.update(i);const e=be.xr.isPresenting&&((n=(t=be.xr).getCamera)==null?void 0:n.call(t))||kt;if(uo.update(i,e),fo.update(i,e),$e.pulseMarkers(Pd.elapsedTime),rs.update(i,be.xr.isPresenting&&((r=(s=be.xr).getCamera)==null?void 0:r.call(s))||kt),be.xr.isPresenting){const c=((a=(o=be.xr).getCamera)==null?void 0:a.call(o))||kt;ii.attach(c),Bd(c),_E(),Bp(),on.update(i,c,Di)}else ii.mesh.visible=!1,Bd(kt);LE(),xE(),sh.syncBoardLight(ct.scale.x),be.render(Fn,kt)});Bi();kp();function cs(){Ct(),A=new Bf({playerCount:bs,solo:pr}),Ft=!1,fr=null,Oe=!1,ye="actions",Yt=null,rn=null,an=Fi(),ws="",On=[],Ue.setHeadline(""),Ue.setScores(Ta(A)),$e.rebuild(A.board),$e.syncPieces(A),rs.rebuild(A.players),uo.clear(),fo.clear(),ai.placeFor(A.current,A.playerCount),Bi(),ki(),Ut()}function oh(){Ct(),A=null,Ft=!1,fr=null,Oe=!1,ye="actions",Yt=null,rn=null,an=Fi(),ws="",On=[],uo.clear(),fo.clear(),Ue.setHeadline(""),Ue.setScores([]),rs.setCelebrating(null),Ue.setResources(Fi()),Bi(),to(),_t(),wt()}function Xb(){return!!A&&A.phase!==F.GAME_OVER}function up({fromHud:i=!1}={}){if(i&&!Xb()){cs();return}if(Vt()){ye="restartConfirm",_t(),wt(),We.click();return}const e=ye==="settings"||ye==="pointerTilt"||ye==="restartConfirm";ye="restartConfirm",Oe=!0,ip(t=>{if(Oe=!1,t){cs();return}if(e){ye="settings",so();return}ye="actions"})}function Id(){return!A||Ft||Oe&&A.phase!==F.STEAL?!1:A.phase===F.DISCARD?A.discardQueue.some(i=>!A.player(i.player).isAI):A.isHuman()}function Ca(){return A?A.phase===F.SETUP_SETTLEMENT?"settlement":A.phase===F.SETUP_ROAD||A.phase===F.FREE_ROADS?"road":A.phase===F.ROBBER?"robber":fr:null}function ki(){if(!A)return;$e.syncPieces(A),Cb(A,Ca()),mE();const i=Er();Ue.setResources((i?A.player(i.player):Rn(A)).resources),Ue.setScores(Ta(A)),_t(),ye==="scores"&&Oe&&!Vt()&&ah(),wt(),rs.setCurrent(A.current),rs.setStealTargets(A.phase===F.STEAL&&A.isHuman()?A.stealCandidates:null),rs.setCelebrating(A.phase===F.GAME_OVER?A.winner:null),ai.placeFor(A.current,A.playerCount)}function Nd(){if(!A)return[{label:"Settings",action:"settings"}];const i=A.isHuman()&&!Ft,e=i&&A.playableCards(A.current).length>0,t=A.phase===F.FREE_ROADS;return[{label:"Roll",action:"roll",disabled:!(i&&A.phase===F.ROLL)},{label:"Road",detail:t?"Free":Ri(pt.road),action:"road",disabled:!(i&&(A.phase===F.MAIN&&A.canAfford(A.current,"road")||t))},{label:"Settle",detail:Ri(pt.settlement),action:"settlement",disabled:!(i&&A.phase===F.MAIN)},{label:"City",detail:Ri(pt.city),action:"city",disabled:!(i&&A.phase===F.MAIN)},{label:"Dev",detail:Ri(pt.dev),action:"cards",disabled:!(i&&A.phase===F.MAIN||e)},{label:"Bank",detail:"4:1",action:"trade",disabled:!(i&&A.phase===F.MAIN)},{label:"End Turn",action:"end",disabled:!(i&&A.phase===F.MAIN)},{label:"Scores",action:"scores"},{label:"Settings",action:"settings"}]}function $b(){return A.stealCandidates.map(i=>{const e=A.player(i);return{label:e.name,action:`steal:${i}`,color:e.color}})}function Ud(){return[{label:An==="gaze"?"Pointer: Face":"Pointer: Hand",action:"pointer",on:An==="gaze"},{label:"Pointer tilt",detail:Ra(),action:"pointerTilt"},{label:ci?"Pointer lines ON":"Pointer lines OFF",action:"pointerLines",on:ci},{label:sn?"Antialias ON":"Antialias OFF",action:"antialias",on:sn},{label:Wn?"Passthrough ON":"Passthrough OFF",action:"passthrough",on:Wn},{label:As?"Handles ON":"Handles OFF",action:"handles",on:As},...A?[{label:"Restart game",action:"restartAsk"}]:[],{label:"Back",action:"settingsBack"}]}function Od(){return[{label:"▲ Up",action:"pointerTiltUp"},{label:Ra(),action:"pointerTiltValue",disabled:!0},{label:"▼ Down",action:"pointerTiltDown"},{label:"Back",action:"pointerTiltBack"}]}function Yb(){return[{label:"Restart",action:"restart"},{label:"Back",action:"restartBack"}]}function jb(){const i=A.isHuman()&&!Ft,e=A.playableCards(A.current);return[{label:"Buy card",detail:Ri(pt.dev),action:"dev",disabled:!(i&&A.phase===F.MAIN&&A.canAfford(A.current,"dev")&&A.devDeck.length)},...e.map(t=>({label:Gb[t.type]||t.type,action:`playDev:${t.id}`})),{label:"Back",action:"cardsBack"}]}function qb(){const i=Rn(A);return[...Xe.map(e=>{const t=A.tradeRate(i,e);return{label:st[e],detail:`Give ${t}:1`,action:`give:${e}`,color:wn[e],selected:Yt===e,disabled:(i.resources[e]||0)<t}}),...Xe.map(e=>({label:st[e],detail:"Get",action:`get:${e}`,color:wn[e],selected:rn===e,disabled:e===Yt||(A.bank[e]||0)<1})),{label:Yt?`Bank ${A.tradeRate(i,Yt)}:1`:"Bank 4:1",action:"tradeGo",disabled:!A.canBankTrade(i.id,Yt,rn)},{label:"Cancel",action:"tradeCancel"}]}function Kb(){const i=Pa();if(!i)return[{label:"Waiting",action:"discardGo",disabled:!0}];const e=A.player(i.player),t=Xe.reduce((n,s)=>n+(an[s]||0),0);return[...Xe.map(n=>({label:`${st[n]} ${an[n]}/${e.resources[n]}`,action:`discard:${n}`,color:wn[n],disabled:!e.resources[n]||an[n]>=e.resources[n]||t>=i.must})),{label:t===i.must?"Discard":`Discard ${t}/${i.must}`,action:"discardGo",disabled:t!==i.must},{label:"Clear",action:"discardClear",disabled:t===0}]}function Zb(){return Xe.map(i=>({label:st[i],action:`plenty:${i}`,color:wn[i],selected:On.includes(i)}))}function Jb(){return Xe.map(i=>({label:st[i],action:`mono:${i}`,color:wn[i]}))}function Qb(){return[{label:"Back",action:"scoresBack"}]}function eE(){return[{label:"Play Again",action:"restart"},{label:"Main Menu",action:"mainMenu"}]}function tE(){return[{label:`Players: ${bs}`,action:"titlePlayers"},{label:pr?"You vs AI":"Hotseat",action:"titleMode"},{label:"Begin the voyage",action:"titleStart"},{label:"Settings",action:"settings"}]}function dp(){if((A==null?void 0:A.phase)!==F.GAME_OVER||A.winner==null){Ue.setHeadline("");return}const i=A.player(A.winner);Ue.setHeadline(`${i.name} Wins!`,i.color)}function Er(){return A&&A.discardQueue.find(i=>!A.player(i.player).isAI)||null}function Pa(){const i=Er(),e=i?`${i.player}:${i.must}`:"";return e!==ws&&(ws=e,an=Fi()),i}function nE(){if(ye==="restartConfirm")return"This starts a new island (same player count and mode).";if(ye==="scores"&&A)return"Public VP hides opponents’ victory-point cards.";if(ye==="trade"&&A){const e=Rn(A);if(!Yt)return`${e.name} · Bank 4:1 — pick what to give, then Grain or another to get`;const t=A.tradeRate(e,Yt),n=`${t} ${st[Yt]}`;return rn?`${e.name} · Bank ${t}:1 · ${n} → 1 ${st[rn]}`:`${e.name} · Give ${n} to the bank — pick what to get`}if(ye==="cards"&&A)return`${A.player().name} · Play a card or buy one`;const i=(A==null?void 0:A.phase)===F.DISCARD?Er():null;if(i){const e=Xe.reduce((r,o)=>r+(an[o]||0),0),t=A.player(i.player),n=ho(A),s=`${t.name} · discard ${e} / ${i.must} on the panel`;return n?`${n.diceLine}
${s}`:s}if((A==null?void 0:A.phase)===F.PLENTY&&A.isHuman()){const e=On.map(t=>st[t]).join(", ");return e?`${A.player().name} · Picked ${e} (${On.length}/2)`:`${A.player().name} · Pick two resources on the panel`}return(A==null?void 0:A.phase)===F.MONOPOLY&&A.isHuman()?`${A.player().name} · Name a resource on the panel`:A?Rb(A):""}function wt(){const i=Cn();if(!A){Ue.setStatus(""),Vt()&&i?ii.set("Point with your view, pinch to select."):Vt()||(ii.mesh.visible=!1);return}const e=nE(),t=ho(A),n=Sr(A),s=$f(A),r=n?t?`${t.diceLine} · ${n}`:n:s?t?`${t.banner} · ${s}`:s:t==null?void 0:t.banner;if(Ue.setStatus(e),!Vt()){ii.mesh.visible=!1;return}i?ii.set(r||"Point with your view, pinch to select."):ii.set(r||e)}function _t(){if(!A){if(ye==="settings"){Ue.setButtons(Ud(),"settings");return}if(ye==="pointerTilt"){Ue.setButtons(Od(),"pointerTilt");return}if(Vt()){Ue.setButtons(tE(),"title");return}Ue.setButtons(Nd(),"actions");return}if(A.phase!==F.MAIN&&ye==="trade"&&(ye="actions"),![F.MAIN,F.ROLL].includes(A.phase)&&ye==="cards"&&(ye="actions"),La()&&ye==="scores"&&(ye="actions"),A.phase===F.STEAL&&A.isHuman()){Ue.setButtons($b(),"steal");return}if(A.phase===F.DISCARD&&Er()){Ue.setButtons(Kb(),"discard");return}if(A.phase===F.PLENTY&&A.isHuman()){Ue.setButtons(Zb(),"plenty");return}if(A.phase===F.MONOPOLY&&A.isHuman()){Ue.setButtons(Jb(),"monopoly");return}if(A.phase===F.GAME_OVER){dp(),Ue.setButtons(eE(),"win");return}if(ye==="settings"){Ue.setButtons(Ud(),"settings");return}if(ye==="pointerTilt"){Ue.setButtons(Od(),"pointerTilt");return}if(ye==="restartConfirm"){Ue.setButtons(Yb(),"restartConfirm");return}if(ye==="scores"){Ue.setButtons(Qb(),"scores");return}if(ye==="trade"){Ue.setButtons(qb(),"trade");return}if(ye==="cards"){Ue.setButtons(jb(),"cards");return}Ue.setButtons(Nd(),"actions")}function Pl(i){if(i==="settings")ye="settings";else if(i==="settingsBack")ye="actions";else if(i==="pointerTilt")ye="pointerTilt";else if(i==="pointerTiltBack")ye="settings";else if(i==="pointerTiltUp")Dd(Zn+_a);else if(i==="pointerTiltDown")Dd(Zn-_a);else if(i==="restartAsk")if(Vt())ye="restartConfirm";else{up();return}else if(i==="restartBack")ye="settings";else if(i==="passthrough")ca(!Wn);else if(i==="pointer")OE(An==="gaze"?"controller":"gaze");else if(i==="pointerLines")FE(!ci);else if(i==="antialias")BE(!sn);else if(i==="handles")As=!As,zE();else if(i==="restart"){We.click(),cs();return}if(i==="settingsBack"&&!Vt()){Oe=!1,Ct(),_t(),wt(),We.click();return}_t(),wt(),We.click(),so()}function La(){return!A||A.phase===F.GAME_OVER?!0:A.isHuman()?A.phase===F.STEAL||A.phase===F.DISCARD||A.phase===F.PLENTY||A.phase===F.MONOPOLY:!1}function iE(){return A?La():!1}function sE(){return{gaze:An==="gaze",tiltLabel:Ra(),lines:ci,antialias:sn,passthrough:Wn,handles:As,canRestart:!!A}}function so(){if(!Vt()){if(ye==="settings"){Oe=!0,Ob(sE(),i=>Pl(i));return}ye==="pointerTilt"&&(Oe=!0,Fb({tiltLabel:Ra()},i=>Pl(i)))}}function rE(){if(!iE()){if(Vt()){ye="settings",Oe=!1,Ct(),_t(),wt(),We.click();return}ye="settings",so(),We.click()}}function ah(){Ub(A,()=>{Oe=!1,ye==="scores"&&(ye="actions"),_t(),wt()})}function fp(){if(!(!A||La())){if(Vt()){ye="scores",Oe=!1,Ct(),_t(),wt(),We.click();return}ye="scores",Oe=!0,ah(),We.click()}}function oE(){ye==="scores"&&(ye="actions"),Oe=!1,Ct(),_t(),wt(),We.click()}function aE(){ye="trade",Yt=null,rn=null,Oe=!0,_t(),wt(),!Vt()&&Nb(A,(i,e)=>{if(Oe=!1,ye="actions",Yt=rn=null,!i||!e){ki();return}if(!A.bankTrade(Rn(A).id,i,e)){Un(A.whyNotBankTrade(Rn(A).id,i,e)||"Cannot make that trade."),ki();return}Ut()})}function cE(){Yt=rn=null,ye="actions",Oe=!1,Ct(),_t(),wt(),We.click()}function lE(){if(!(Ft||!Yt||!rn)){if(!A.bankTrade(Rn(A).id,Yt,rn)){Un(A.whyNotBankTrade(Rn(A).id,Yt,rn)||"Cannot make that trade.");return}Yt=rn=null,ye="actions",Oe=!1,Ct(),We.click(),Ut()}}function hE(i){if(Ft)return;const e=Pa();if(!e)return;const t=A.player(e.player),n=Xe.reduce((s,r)=>s+(an[r]||0),0);an[i]>=t.resources[i]||n>=e.must||(an[i]+=1,_t(),wt(),Ue.setResources(t.resources),We.click())}function uE(){if(Ft)return;const i=Pa();!i||Xe.reduce((t,n)=>t+(an[n]||0),0)!==i.must||A.discard(i.player,{...an})&&(an=Fi(),ws="",Oe=!1,Ct(),We.click(),Ut())}function dE(i){if(!(Ft||!A||A.phase!==F.PLENTY||!A.isHuman())){if(On.push(i),On.length>=2){const[e,t]=On;if(On=[],!A.yearOfPlenty(e,t))return;Oe=!1,Ct(),We.click(),Ut();return}_t(),wt(),We.click()}}function fE(i){Ft||!A||A.phase!==F.MONOPOLY||!A.isHuman()||A.monopoly(i)&&(Oe=!1,Ct(),We.click(),Ut())}function pE(i){if(i==="mainMenu")return We.click(),oh(),!0;if(i==="titleStart")return We.unlock(),We.click(),cs(),!0;if(i==="titlePlayers")return bs=bs>=4?2:bs+1,to(),_t(),We.click(),!0;if(i==="titleMode")return pr=!pr,to(),_t(),We.click(),!0;if(cp.has(i))return Pl(i),!0;if(i==="scores")return fp(),!0;if(i==="scoresBack")return oE(),!0;if(i==="cards")return ye="cards",_t(),wt(),We.click(),!0;if(i==="cardsBack")return ye="actions",_t(),wt(),We.click(),!0;if(i==="tradeCancel")return cE(),!0;if(i==="tradeGo")return lE(),!0;const e=Ei(Ys(i,"give:"));if(e)return Ft||(Yt=e,rn===e&&(rn=null),_t(),wt(),We.click()),!0;const t=Ei(Ys(i,"get:"));if(t)return Ft||(rn=t,_t(),wt(),We.click()),!0;const n=Ys(i,"discard:");if(n)return hE(n),!0;if(i==="discardGo")return uE(),!0;if(i==="discardClear")return Ft||(an=Fi(),_t(),wt(),We.click()),!0;const s=Ys(i,"plenty:");if(s)return dE(s),!0;const r=Ys(i,"mono:");if(r)return fE(r),!0;const o=Ys(i,"playDev:");if(o!=null)return ye="actions",no("playDev",o),!0;const a=yE(i);return a!=null?(Tr(a),!0):!1}function mE(){if(!A||!A.isHuman()){$e.clearHighlights();return}const i=A.current,e=Ca();if(e==="settlement"){const t=A.phase===F.SETUP_SETTLEMENT;$e.showVertices(A.validSettlements(i,{setup:t})),$e.showEdges([]),$e.showHexes([])}else if(e==="city")$e.showVertices(A.validCities(i)),$e.showEdges([]),$e.showHexes([]);else if(e==="road")$e.showVertices([]),$e.showEdges(A.validRoads(i,{setup:A.phase===F.SETUP_ROAD,free:A.phase===F.FREE_ROADS})),$e.showHexes([]);else if(e==="robber")$e.showVertices([]),$e.showEdges([]),$e.showHexes(A.board.land.filter(t=>t.id!==A.board.robberHex).map(t=>t.id));else if(A.phase===F.MAIN){const t=[];A.canAfford(i,"settlement")&&t.push(...A.validSettlements(i)),A.canAfford(i,"city")&&t.push(...A.validCities(i)),$e.showVertices(t),$e.showEdges(A.canAfford(i,"road")?A.validRoads(i):[]),$e.showHexes([])}else $e.clearHighlights()}function ch(i){return Rl.setFromRotationMatrix(i.matrixWorld),Ed.setFromQuaternion(Rl,"YXZ"),Ed.y}function Di(i,e=Oi){var n;const t=(n=i.joints)==null?void 0:n["index-finger-tip"];return t?t.getWorldPosition(e):i.getWorldPosition(e),e}function gE(i,e=.16){Di(i,Oi);let t=null,n=e;for(const s of[on.left,on.right]){if(on.isStuck(s))continue;const r=Oi.distanceTo(s.position);r<n&&(n=r,t=s)}return t}function pp(i){var t,n,s;if(un.has(i))return!0;let e=gE(i);if(!e){const r=new P().setFromMatrixPosition(i.matrixWorld),o=new P(0,0,-1).transformDirection(i.matrixWorld);$t.set(r,o),e=(s=(n=(t=$t.intersectObjects(on.pickables(),!0)[0])==null?void 0:t.object)==null?void 0:n.userData)==null?void 0:s.handleRoot,e&&on.isStuck(e)&&(e=null)}return e?(Di(i,Oi),un.set(i,{handle:e,offset:ct.position.clone().sub(Oi),yaw0:ch(i),stageYaw0:ct.rotation.y}),on.stick(e,i),Gn=un.size===2?mp():null,We.click(),!0):!1}function mp(){const[i,e]=un.keys();return Di(i,si),Di(e,ri),{startDist:Math.max(.08,si.distanceTo(ri)),startScale:ct.scale.x,startYaw:Math.atan2(ri.x-si.x,ri.z-si.z),startStageYaw:ct.rotation.y,startMid:si.clone().add(ri).multiplyScalar(.5),startPos:ct.position.clone()}}function gp(i){const e=un.get(i);if(e&&on.unstick(e.handle),un.delete(i),Gn=null,un.size===1){const[t,n]=un.entries().next().value;Di(t,Oi),n.offset=ct.position.clone().sub(Oi),n.yaw0=ch(t),n.stageYaw0=ct.rotation.y}}function _E(){if(un.size===2){Gn||(Gn=mp());const[i,e]=un.keys();Di(i,si),Di(e,ri);const t=Math.max(.08,si.distanceTo(ri)),s=Math.atan2(ri.x-si.x,ri.z-si.z)-Gn.startYaw,r=Math.min(2.4,Math.max(.45,Gn.startScale*(t/Gn.startDist))),o=r/Gn.startScale;ct.scale.setScalar(r),ct.rotation.y=Gn.startStageYaw+s,Td.copy(si).add(ri).multiplyScalar(.5),Zo.copy(Gn.startPos).sub(Gn.startMid).multiplyScalar(o).applyAxisAngle(Ad,s),ct.position.copy(Td).add(Zo);return}for(const[i,e]of un){Di(i,Oi);const t=ch(i)-e.yaw0;Zo.copy(e.offset).applyAxisAngle(Ad,t),ct.position.copy(Oi).add(Zo),ct.rotation.y=e.stageYaw0+t}}function xE(){const i=document.getElementById("spot-layer");if(!i)return;const e=be.xr.isPresenting;for(const o of $e.vertexMarkers.values())for(const a of o.children)a.visible=o.visible&&(e||o===$e.hoverObj);if(!A||e){i.childElementCount&&i.replaceChildren();return}const t=[];for(const[o,a]of $e.vertexMarkers)a.visible&&t.push([o,a]);i.childElementCount!==t.length&&i.replaceChildren(...t.map(([o])=>{const a=document.createElement("button");return a.type="button",a.className="spot",a.dataset.vertex=o,a.setAttribute("aria-label","Place here"),a}));const n=innerWidth,s=innerHeight,r=i.children;for(let o=0;o<t.length;o++){const[a,c]=t[o];c.getWorldPosition(Ki),Ki.project(kt);const l=r[o];l.dataset.vertex!==a&&(l.dataset.vertex=a);const h=Ki.z>-1&&Ki.z<1&&Math.abs(Ki.x)<=1.2&&Math.abs(Ki.y)<=1.2;l.style.display=h?"block":"none",l.style.transform=`translate(${Ki.x*.5*n+n*.5-9}px, ${-Ki.y*.5*s+s*.5-9}px)`}}function vE(){return!!(A&&!Ft&&A.isHuman()&&A.phase===F.ROLL)}function _p(){return!A||Ft||!A.isHuman()||A.phase===F.SETUP_SETTLEMENT||A.phase===F.SETUP_ROAD?"Not your roll":"Already rolled"}function Da(){const i=[...on.pickables(),...rs.pickables(),...ai.pickables()];Vt()&&i.push(...Ue.pickables());for(const e of $e.vertexMarkers.values())e.visible&&i.push(e);for(const e of $e.edgeMarkers.values())e.visible&&i.push(e);for(const e of $e.hexMarkers.values())e.visible&&e.material.opacity>0&&i.push(e);if(A&&Ca()==="robber"){for(const e of $e.hexMeshes.values())i.push(e);for(const e of $e.tokenMeshes.values())i.push(e)}return i}function yE(i){return typeof i!="string"||!i.startsWith("steal:")?null:Number(i.slice(6))}function xp(){const i=Sr(A);i&&(Un(i,jf,{low:!0}),Vt()&&fo.spawn(i,Ue.stealFloatWorldPos(lp),yb))}function Tr(i){return!A||Ft||A.phase!==F.STEAL||!A.isHuman()||!A.steal(Number(i))?!1:(Ct(),Oe=!1,We.click(),xp(),Ut(),!0)}function lh(i){if(!i)return;const e=i.userData;if(e.kind==="dice"||e.kind==="tray"&&e.action==="roll"){vE()?(e.kind==="tray"&&Ue.flashPress("roll"),no("roll")):qs(_p(),i);return}if(e.kind==="tray"){if(e.disabled&&!cp.has(e.action)){A&&Id()&&Vb.has(e.action)&&(Ue.flashPress(e.action),qs(vp(e.action),i));return}if(Ue.flashPress(e.action),pE(e.action)||!A||e.disabled)return;no(e.action);return}if(e.kind==="avatar"){Tr(e.id);return}if(A&&Id()){if(e.kind==="vertex"){const t=Ca();if(!(t==="city"?A.placeCity(e.id):t==="settlement"?A.placeSettlement(e.id):A.placeCity(e.id)||A.placeSettlement(e.id))){qs(ME(e.id,t),i);return}$e.flashPick(i),We.place(),fr=null,Ut()}else if(e.kind==="edge"){if(!A.placeRoad(e.id)){qs(A.whyNotRoad(e.id),i);return}$e.flashPick(i),We.place(),fr=null,Ut()}else if(e.kind==="hex"){if(!A.moveRobber(e.id))return;$e.flashPick(i),We.place(),A.phase!==F.STEAL&&Un("No neighbor to steal from.",jf),Ut()}}}function vp(i){return i==="road"?A.whyNotRoad():i==="settlement"?A.whyNotSettlement():i==="city"?A.whyNotCity():i==="dev"||i==="cards"?A.whyNotDev():"Can't build"}function ME(i,e){var n;if(e==="city")return A.whyNotCity(i);if(e==="settlement")return A.whyNotSettlement(i);const t=A.board.vertices.get(i);return((n=t==null?void 0:t.building)==null?void 0:n.player)===A.current&&t.building.type==="settlement"?A.whyNotCity(i):A.whyNotSettlement(i)}function SE(i,e){const t=(i==null?void 0:i.userData)||{};if(t.kind==="vertex"){const n=$e.vertexMarkers.get(t.id);if(n)return n.getWorldPosition(e)}if(t.kind==="edge"){const n=$e.edgeMarkers.get(t.id);if(n)return n.getWorldPosition(e)}if(t.kind==="hex"){const n=$e.hexMarkers.get(t.id)||$e.hexMeshes.get(t.id);if(n)return n.getWorldPosition(e)}return t.kind==="dice"?(i!=null&&i.isObject3D?i:ai.group).getWorldPosition(e):t.kind==="tray"||t.action?Ue.buttonWorldPos(t.action,e):i!=null&&i.isObject3D?i.getWorldPosition(e):Ue.group.getWorldPosition(e)}function qs(i,e){const t=String(i||"").trim();t&&(We.bad(),Vt()?fo.spawn(t,SE(e,lp)):Un(t))}function Ia(i){var r;if(!i.length)return null;if(((r=i[0].object.userData)==null?void 0:r.kind)==="dice")return i[0].object;const e=i.find(o=>{var a;return((a=o.object.userData)==null?void 0:a.kind)==="tray"});if(e)return e.object;const t=i.find(o=>{var a;return((a=o.object.userData)==null?void 0:a.kind)==="avatar"});if(t)return t.object;const n=i.find(o=>{var a;return(a=o.object.userData)==null?void 0:a.handleRoot});if(n)return n.object;const s=i.find(o=>{var a;return((a=o.object.userData)==null?void 0:a.kind)==="vertex"});return s?s.object:i[0].object}function bE(){$t.setFromCamera(eo,kt),lh(Ia($t.intersectObjects(Da(),!0)))}function aa(i,e){return $t.set(i,e),Ia($t.intersectObjects(Da(),!0))}function yp(){var e,t;const i=(t=(e=be.xr).getSession)==null?void 0:t.call(e);return i?[...i.inputSources]:[]}function Na(i){const e=i==null?void 0:i.targetRayMode;return e==="transient-pointer"||e==="gaze"}function po(i){const e=i==null?void 0:i.targetRayMode;return e==="tracked-pointer"||e==="transient-pointer"}function mo(i){var t;if(!i)return!1;const e=(t=i.userData)==null?void 0:t.inputSource;return!e||po(e)}function EE(){if(Zr)return!0;const i=navigator.userAgent||"",e=/Safari/.test(i)&&!/Chrome|Chromium|Android|Edg|Firefox|OPR/.test(i);return!!(navigator.xr&&e&&/Macintosh|Apple Vision|iPad|iPhone/.test(i))}function hh(){return yp().some(i=>i.targetRayMode==="tracked-pointer")}function Cn(){return be.xr.isPresenting&&An==="gaze"}function TE(i){var e,t;return(i==null?void 0:i.frame)||((t=(e=be.xr).getFrame)==null?void 0:t.call(e))||null}function uh(i){return(i==null?void 0:i.inputSource)||(i==null?void 0:i.data)||null}function dh(i,e){var n,s;const t=((s=(n=be.xr).getCamera)==null?void 0:s.call(n))||kt;t.updateMatrixWorld(),t.getWorldPosition(i),t.getWorldDirection(e),Zn&&(wd.setFromMatrixColumn(t.matrixWorld,0).normalize(),e.applyAxisAngle(wd,$l.degToRad(Zn)).normalize())}function Mp(i,e,t){var s;i.setFromMatrixPosition(t.matrixWorld);const n=(s=t.joints)==null?void 0:s["index-finger-tip"];n&&n.getWorldPosition(i),e.set(0,0,-1).transformDirection(t.matrixWorld)}function Sp(i,e,t,n){var c,l;const s=(l=(c=be.xr).getReferenceSpace)==null?void 0:l.call(c);if(!n||!(t!=null&&t.targetRaySpace)||!s)return!1;let r=null;try{r=n.getPose(t.targetRaySpace,s)}catch{return!1}if(!r)return!1;const{position:o,orientation:a}=r.transform;return i.set(o.x,o.y,o.z),e.set(0,0,-1).applyQuaternion(Rl.set(a.x,a.y,a.z,a.w)),e.normalize(),!0}function bp(i,e,t,n){if(Cn())return dh(i,e),!0;const s=uh(t);return po(s)&&Sp(i,e,s,TE(t))?!0:n&&mo(n)?(Mp(i,e,n),!0):!1}function Ep(i,e){if(!bp($n,Tn,i,e))return Cn()?ga:null;const t=aa($n,Tn);return t||(Cn()?ga:null)}function fh(i,e){if(!bc[i]){bc[i]=!0;try{e()}finally{queueMicrotask(()=>{bc[i]=!1})}}}function Tp(i){return!!(Cn()||An==="gaze"||Na(i)||!hh())}function Ap(i){const e=performance.now()-op;return e<80?!0:Tp(i)?e<zb:!1}function wp(){op=performance.now()}function AE(i,e){return!(!e||Na(i)||!hh()&&(Zr||EE()))}function Rp(i,e){const t=uh(i);return!Cn()&&!po(t)&&!mo(e)||Ap(t)||e&&un.has(e)&&!Na(t)?!1:(wp(),lh(Ep(i,e)),!0)}function Ll(i,e){fh("selectstart",()=>{var s;const t=uh(i);if(!Cn()&&!po(t)&&!mo(e)||AE(t,e)&&(pp(e),un.has(e)))return;const n=Ep(i,e);((s=n==null?void 0:n.userData)==null?void 0:s.kind)==="tray"&&!n.userData.disabled&&Ue.setPressed(n.userData.action),Tp(t)&&Rp(i,e)})}function Dl(i,e){fh("select",()=>{Rp(i,e)})}function Il(i){fh("selectend",()=>{i&&gp(i),Ue.setPressed(null)})}function Cp(i){Ll(i,null)}function Pp(i){Dl(i,null)}function Lp(){Il(null)}function Nl(i){var n,s;const e=(i==null?void 0:i.target)||((s=(n=be.xr).getSession)==null?void 0:s.call(n));if(!e)return;for(const r of e.inputSources)Na(r)&&(Zr=!0);const t=Math.max(ap,e.inputSources.length);for(let r=0;r<t;r++)be.xr.getController(r);Ii()}function wE(i){!i||Jr===i||(Ul(),i.addEventListener("select",Pp),i.addEventListener("selectstart",Cp),i.addEventListener("selectend",Lp),i.addEventListener("inputsourceschange",Nl),Jr=i,Nl({target:i}))}function Ul(){const i=Jr;i&&(i.removeEventListener("select",Pp),i.removeEventListener("selectstart",Cp),i.removeEventListener("selectend",Lp),i.removeEventListener("inputsourceschange",Nl),Jr=null)}function RE(){const i=[ct];return on.group.visible&&i.push(on.group),i}function CE(i){var t,n,s;if(!i||i.isLine||i.isPoints||i.isSprite||(t=i.userData)!=null&&t.pointerLaser)return!0;const e=i.material;if(e&&(Array.isArray(e)?e:[e]).every(o=>o&&o.transparent&&o.opacity<.02)||(n=i.userData)!=null&&n.gazeHitDot)return!0;for(let r=i;r;r=r.parent)if(r===dr||r===Ti||r===ii.mesh||(s=r.userData)!=null&&s.pointerLaser)return!0;return!1}function Dp(i,e){const t=-Math.min(wa,Math.max(.02,e)),n=i.geometry.attributes.position;n.getZ(1)!==t&&(n.setZ(1,t),n.needsUpdate=!0,i.geometry.computeBoundingSphere())}function ph(i,e,t=wa){const n=$t.near,s=$t.far;$t.near=0,$t.far=t,$t.set(i,e);const r=$t.intersectObjects(RE(),!0);$t.near=n,$t.far=s;for(const o of r)if(!CE(o.object))return o;return null}function Ip(i,e){const t=ph(i,e);return t?Math.max(.02,t.distance-Hb):wa}function PE(){if(ci)for(const i of rh){const e=i.userData.laser;e&&($n.setFromMatrixPosition(i.matrixWorld),Tn.set(0,0,-1).transformDirection(i.matrixWorld).normalize(),Dp(e,Ip($n,Tn)))}}function Fd(i,e){var t,n,s;return((t=i==null?void 0:i.userData)==null?void 0:t.kind)==="tray"||((n=i==null?void 0:i.userData)==null?void 0:n.kind)==="dice"||(s=i==null?void 0:i.userData)!=null&&s.handleRoot?{obj:i,done:!0}:i&&!e?{obj:i,done:!1}:{obj:e,done:!1}}function LE(){var e,t;let i=null;if(be.xr.isPresenting){if(PE(),Cn())dh($n,Tn),i=aa($n,Tn);else{const n=((t=(e=be.xr).getFrame)==null?void 0:t.call(e))||null;for(const s of yp()){if(!po(s)||!Sp($n,Tn,s,n))continue;const r=Fd(aa($n,Tn),i);if(i=r.obj,r.done)break}if(!i)for(const s of rh){if(!s.visible||!mo(s))continue;Mp($n,Tn,s);const r=Fd(aa($n,Tn),i);if(i=r.obj,r.done)break}}ga=i}else $t.setFromCamera(eo,kt),i=Ia($t.intersectObjects(Da(),!0)),io&&(i={userData:{kind:"vertex",id:io}});UE(),Ue.setHover(i),on.setHover(i),rs.setHover(i),$e.setHover(i),ai.setHover(i)}function DE(){const i=new eS,e=new sS;e.setPath("https://cdn.jsdelivr.net/npm/@webxr-input-profiles/assets@1.0/dist/profiles");const t=new Sa({color:16770736}),n=[];for(let s=0;s<ap;s++){const r=be.xr.getController(s),o=new Qt().setFromPoints([new P(0,0,0),new P(0,0,-wa)]),a=new oo(o,t);if(a.userData.pointerLaser=!0,r.userData.laser=a,r.add(a),r.addEventListener("selectstart",c=>{Ll(c,r)}),r.addEventListener("selectend",()=>{Il(r)}),r.addEventListener("select",c=>{Dl(c,r)}),r.addEventListener("squeezestart",()=>{pp(r)||(A==null?void 0:A.phase)===F.MAIN&&A.isHuman()&&!Ft&&no("end")}),r.addEventListener("squeezeend",()=>{gp(r)}),Fn.add(r),s<2){const c=be.xr.getControllerGrip(s);c.add(i.createControllerModel(c)),Fn.add(c);const l=be.xr.getHand(s);l.add(e.createHandModel(l,"mesh")),l.addEventListener("pinchstart",()=>{var d,p,g;const u={inputSource:((d=l.userData)==null?void 0:d.inputSource)||null,frame:(g=(p=be.xr).getFrame)==null?void 0:g.call(p)};Ll(u,l),Dl(u,l)}),l.addEventListener("pinchend",()=>Il(l)),Fn.add(l)}n.push(r)}return n}function IE(){const i=new Ze,e=new ie(new co(.0055,.0088,16),new rt({color:16769162,side:Jt,depthTest:!1,depthWrite:!1,toneMapped:!1})),t=new ie(new ao(.0032,8),new rt({color:16775388,depthTest:!1,depthWrite:!1,toneMapped:!1}));return e.renderOrder=26,t.renderOrder=27,i.add(e,t),i.position.set(0,0,-.5),i.renderOrder=25,i.frustumCulled=!1,i.visible=!1,kt.add(i),i}function NE(){const i=new Ze;i.userData.gazeHitDot=!0;const e=new ie(new jt(.005,8,6),new rt({color:16775388,toneMapped:!1,depthWrite:!1,polygonOffset:!0,polygonOffsetFactor:-2,polygonOffsetUnits:-2})),t=new ie(new jt(.009,8,6),new rt({color:16769162,toneMapped:!1,depthWrite:!1,transparent:!0,opacity:.9,polygonOffset:!0,polygonOffsetFactor:-2,polygonOffsetUnits:-2}));return e.renderOrder=29,t.renderOrder=28,e.frustumCulled=!1,t.frustumCulled=!1,i.add(t,e),i.frustumCulled=!1,i.visible=!1,Fn.add(i),i}function Np(i){return i?(Ti.position.copy(i.point),i.normal&&i.normal.lengthSq()>1e-8?(Jo.copy(i.normal).normalize(),Jo.dot(Tn)>0&&Jo.negate(),Ti.position.addScaledVector(Jo,Cd)):Ti.position.addScaledVector(Tn,-Cd),Ti.visible=!0,!0):(Ti.visible=!1,!1)}function UE(){if(!be.xr.isPresenting||!Cn()){Ti.visible=!1;return}Np(ph($n,Tn))}function Bd(i){if(!i||dr.parent===i){Ii();return}i.add(dr),Ii()}function OE(i){An=i==="gaze"?"gaze":"controller";try{localStorage.setItem("catan-pointer-mode",An)}catch{}Ii(),(Cn()||An==="gaze")&&(Un("Point with your view, pinch to select."),be.xr.isPresenting&&ii.set("Point with your view, pinch to select."))}function Ii(){const i=Cn();dr&&(dr.visible=!1),(!be.xr.isPresenting||!i)&&(Ti.visible=!1);for(const e of rh){const t=e.userData.laser;t&&(t.visible=ci&&An!=="gaze"&&!i&&!!e.visible&&mo(e))}}function FE(i){ci=!!i;try{localStorage.setItem("catan-pointer-lines",ci?"1":"0")}catch{}Ii()}function BE(i){sn=!!i,Te.antialias=sn,ma.antialias=sn;try{localStorage.setItem("catan-antialias",sn?"1":"0")}catch{}kE()}function kE(){try{const i=be.getRenderTarget();i&&"samples"in i&&(i.samples=sn?4:0)}catch{}}function ca(i){Wn=!!i,sh.room.visible=!Wn,Fn.background=Wn?null:rp,Fn.fog=Wn?null:new Ma("#1b140f",6,12),be.setClearColor(Wn?0:1774607,Wn?0:1),be.setClearAlpha(Wn?0:1)}function la(i){be.xr.setFramebufferScaleFactor(Te.framebufferScale),ma.antialias=sn,DS(be,sh.sun,{enabled:i?Te.xrShadows:Te.shadows,size:i?Te.xrShadowSize:Te.shadowSize})}function zE(){on.setVisible(As&&be.xr.isPresenting)}function Up(){ct.position.set(0,0,Aa)}function HE(){er=!0,tr=0,Qr=!1}function VE(){return ct.position.y+Mn*Math.max(1e-4,ct.scale.y)}function Op(i){const e=Math.min(wl,Math.max(.35,kb));return Math.max(i-e,i-wl)}function Fp(i){const e=Math.max(1e-4,ct.scale.y),t=Op(i);ct.position.set(0,t-Mn*e,Aa)}function GE(i){const e=i-wl,t=VE();return t+1e-4>=e?!1:(ct.position.y+=Op(i)-t,!0)}function WE(){var t,n,s,r;const i=(n=(t=be.xr).getFrame)==null?void 0:n.call(t),e=(r=(s=be.xr).getReferenceSpace)==null?void 0:r.call(s);if(i&&e)try{const o=i.getViewerPose(e);if(o){const a=o.transform.position;return{x:a.x,y:a.y,z:a.z}}}catch{}return null}function XE(i){if(!i||!Number.isFinite(i.y))return!1;const e=Math.abs(i.x),t=Math.abs(i.y),n=Math.abs(i.z);return!(e<Sc&&t<Sc&&n<Sc)}function $E(i){var t,n;if(i&&Number.isFinite(i.y))return i.y;const e=(n=(t=be.xr).getCamera)==null?void 0:n.call(t);return e!=null&&e.position&&Number.isFinite(e.position.y)?e.position.y:0}function Bp(){if(!be.xr.isPresenting||Qr)return;if(un.size){Qr=!0,er=!1;return}tr++;const i=WE(),e=XE(i);if(!e&&tr<bd)return;const t=$E(i);er?(Fp(t),(e||tr>=bd)&&(er=!1)):GE(t)}async function YE(i){const e=["local-floor","bounded-floor","local"];for(const t of e)try{return await i.requestReferenceSpace(t),Rd=t,be.xr.setReferenceSpaceType(t),t}catch{}return Rd="local",be.xr.setReferenceSpaceType("local"),"local"}be.xr.addEventListener("sessionstart",()=>{HE(),Bi(),_t(),wt()});be.xr.addEventListener("sessionend",()=>{er=!1,tr=0,Qr=!1,ga=null,Up(),Bi()});function jE(){if(Bi(),!Vt()){if(ye==="settings"||ye==="pointerTilt"){so();return}if(ye==="restartConfirm"){Oe=!0,ip(i=>{if(Oe=!1,i){cs();return}ye="settings",so()});return}if(ye==="scores"&&A&&!La()){Oe=!0,ah();return}if((A==null?void 0:A.phase)===F.GAME_OVER){Oe=!0,np(A,{onPlayAgain:()=>cs(),onMainMenu:()=>oh()});return}qE()}}function qE(){if(!(!A||Vt())){if(A.phase===F.DISCARD&&Er()){Oe=!0,Zf(A,(e,t)=>{Oe=!1,an=Fi(),ws="",A.discard(e,t),Ut()})||(Oe=!1);return}if(A.phase===F.STEAL&&A.isHuman()){Oe=!0,Jf(A,i=>{Tr(i)});return}if(A.phase===F.PLENTY&&A.isHuman()){Oe=!0,Qf((i,e)=>{Oe=!1,On=[],A.yearOfPlenty(i,e),Ut()});return}A.phase===F.MONOPOLY&&A.isHuman()&&(Oe=!0,ep(i=>{Oe=!1,A.monopoly(i),Ut()}))}}async function kd(i,e){const t={requiredFeatures:["local-floor"],optionalFeatures:[...Cl,"dom-overlay","hit-test","plane-detection"],domOverlay:{root:e}},n={optionalFeatures:[...Cl]};try{return await navigator.xr.requestSession(i,t)}catch{return navigator.xr.requestSession(i,n)}}async function KE(){var n,s,r,o;if(We.unlock(),!navigator.xr){Un("WebXR is not available in this browser.");return}const i=document.getElementById("overlay-root")||document.getElementById("hud"),e=await((s=(n=navigator.xr).isSessionSupported)==null?void 0:s.call(n,"immersive-ar")),t=await((o=(r=navigator.xr).isSessionSupported)==null?void 0:o.call(r,"immersive-vr"));try{let a=null,c=!1;if(e)try{a=await kd("immersive-ar",i),c=!0}catch{a=null}if(!a&&t&&(a=await kd("immersive-vr",i)),!a){Un("This browser has no AR or VR session.");return}await YE(a),la(!0),ca(c),on.setVisible(As),document.documentElement.classList.add("xr-presenting"),Ct(),wE(a),await be.xr.setSession(a),Bi(),_t(),wt(),Ii(),(Cn()||An==="gaze")&&Un("Point with your view, pinch to select."),a.addEventListener("end",()=>{Ul(),Zr=!1,un.clear(),er=!1,tr=0,Qr=!1,Up(),on.setVisible(!1),la(!1),ca(!1),document.documentElement.classList.remove("xr-presenting"),Ii(),jE(),kp()})}catch{Ul(),Zr=!1,Un("Could not start a mixed-reality session."),on.setVisible(!1),la(!1),ca(!1),document.documentElement.classList.remove("xr-presenting"),Ii(),Bi()}}async function kp(){var n,s,r,o;const i=document.getElementById("vr-btn"),e=navigator.xr&&await((s=(n=navigator.xr).isSessionSupported)==null?void 0:s.call(n,"immersive-ar")),t=navigator.xr&&await((o=(r=navigator.xr).isSessionSupported)==null?void 0:o.call(r,"immersive-vr"));e?(i.textContent="Enter MR",i.disabled=!1):t?(i.textContent="Enter VR",i.disabled=!1):(i.textContent="MR unavailable",i.disabled=!0)}function ZE(){return!A||A.phase===F.GAME_OVER?!1:A.phase===F.DISCARD?A.discardQueue.some(i=>A.player(i.player).isAI):A.player().isAI}async function Ut(){const i=A;ki();try{await JE()}finally{if(A!==i)return;ki(),zp()}}function Ec(){if(!A||A.phase!==F.DISCARD)return;let i=0;for(;A.discardQueue.some(e=>A.player(e.player).isAI)&&i++<8&&kf(A););}async function JE(){var e,t;const i=A;if(i){Ft=!0;try{Ec();let n=0,s=null;for(;ZE()&&n++<80;){if(await Tc(i.phase===F.MAIN||i.phase===F.ROLL?700:220),A!==i)return;const r=kf(i),o=i.lastAction;if((o==null?void 0:o.type)==="roll"&&o!==s){s=o,ai.placeFor(i.current,i.playerCount),ai.rollTo(i.dice),We.dice(),(e=o.production)!=null&&e.length&&Hp(o.production),Ec(),ki();const a=(t=o.production)!=null&&t.length?Math.min(4500,Math.max(750,Math.ceil(uo.timeLeft()*1e3))):650;if(await Tc(a),A!==i)return}else if(Ec(),ki(),(o==null?void 0:o.type)==="steal"&&i.lastSteal&&(xp(),await Tc(1800),A!==i))return;if(!r)break}}finally{A===i&&(Ft=!1)}}}function zp(){if(!A)return;const i=Vt();if(A.phase===F.GAME_OVER){We.win(),Oe=!0,dp(),i||np(A,{onPlayAgain:()=>cs(),onMainMenu:()=>oh()}),_t(),wt();return}if(A.phase===F.DISCARD&&Er()){Oe=!0,Pa(),i||Zf(A,(t,n)=>{Oe=!1,an=Fi(),ws="",A.discard(t,n),Ut()})||(Oe=!1),_t(),wt();return}if(A.phase===F.STEAL&&A.isHuman()){Oe=!0,i||Jf(A,e=>{Tr(e)});return}if(A.phase===F.PLENTY&&A.isHuman()){Oe=!0,On=[],i||Qf((e,t)=>{Oe=!1,On=[],A.yearOfPlenty(e,t),Ut()}),_t(),wt();return}A.phase===F.MONOPOLY&&A.isHuman()&&(Oe=!0,i||ep(e=>{Oe=!1,A.monopoly(e),Ut()}),_t(),wt())}function QE(){kt.aspect=innerWidth/innerHeight,kt.updateProjectionMatrix(),be.setSize(innerWidth,innerHeight)}function Hp(i){var t;const e=i??(((t=A==null?void 0:A.lastAction)==null?void 0:t.type)==="roll"?A.lastAction.production:null);!A||!(e!=null&&e.length)||uo.play(e,{board:A.board,players:A.players,playerCount:A.playerCount})}function Tc(i){return new Promise(e=>setTimeout(e,i))}window.__catan={get game(){return A},get tray(){return Ue},get trayScreen(){return ye},get pointerMode(){return An},get pointerPitchDeg(){return Zn},get gazeReticle(){return dr},get gazeHitDot(){return Ti},fillGazeRay:dh,firstWorldHit:ph,placeGazeHitDot:Np,get xrOptionalFeatures(){return Cl},get xrSessionBound(){return Jr},get quality(){return Te},fillPickRay:bp,isDuplicateXRSelect:Ap,markXRSelectHandled:wp,applyStageTableSnap:Fp,maybeSnapStageToTable:Bp,pointerLaserHitDistance:Ip,setLaserLength:Dp,useHeadHover:Cn,hasPersistentPointer:hh,afterAction:Ut,refresh:ki,presentModals:zp,trySteal:Tr,formatRollResult:ho,formatStealResult:Sr};
